...
export const pageMetadata: Record<string, PageMetadata> = {
  ...
  '/learning-center': {
    title: 'Learning Center | Skywash Innovations',
    description: 'Plain-English guides to the stains, growths, and grime that show up on roofs, siding, and windows — and what exterior cleaning can and cannot do about them.',
    canonical: `${baseUrl}/learning-center`
  },
