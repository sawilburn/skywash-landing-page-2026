import { Home, Building2, Sparkles, MapPin, Heart, Users, Shield, CheckCircle2, Star, Award, Clock, TreePine } from 'lucide-react';
import { Link } from 'react-router-dom';
import { DynamicSectionImage } from '../components/DynamicSectionImage';

export function OaktonPage() {
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-20">
          <div className="text-center max-w-5xl mx-auto">
            <div className="inline-flex items-center gap-3 bg-white/10 backdrop-blur-md px-6 py-3 rounded-full text-white mb-8 border border-white/20">
              ...
              <span className="text-sm font-medium tracking-wide">Serving Oakton & Vale</span>
            </div>
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold text-white mb-8 leading-tight tracking-tight">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-200 to-blue-200">
                Oakton Professionals
              </span>
            </h1>

            <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto mb-8 leading-relaxed">
              Professional exterior house cleaning with advanced soft wash technology. Remove algae from vinyl siding and roofs. Expert window cleaning for Oakton homes and businesses.
            </p>
            ...
            <div className="mt-16 flex flex-wrap justify-center gap-12 text-white text-sm">
              <div className="flex items-center gap-3">
                ...
                <span className="font-medium">Serving Oakton & Surrounding Areas</span>
              </div>
              <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="font-medium">Reliable & Professional Service</span>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="flex items-start gap-6 mb-10">
              ...
              <div>
                <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6 tracking-tight">
                  Professional Cleaning for Oakton Homes & Businesses
                </h2>
            ...
            <div className="space-y-8">
              <div className="bg-white rounded-2xl p-8 md:p-10 border border-blue-200 shadow-lg">
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <h3 className="text-2xl md:text-3xl font-bold text-slate-900">
                    Serving All Oakton Neighborhoods
                  </h3>
                </div>
                <div className="space-y-4 text-lg text-slate-700 leading-relaxed">
                  <p>
                    Skywash Innovations delivers expert power washing, roof cleaning, and exterior house cleaning services throughout Oakton, Virginia. From <span className="font-semibold">Oakton Village</span> to <span className="font-semibold">Vale</span>, we serve the community's homes and businesses with professional soft wash technology.
                  </p>
                  <p>
                    Whether your property is in <span className="font-semibold">Waples Mill</span>, <span className="font-semibold">Blake Lane</span>, <span className="font-semibold">Hunter Mill</span>, or near <span className="font-semibold">Flint Hill Road</span>, we expertly remove algae from vinyl siding cleaning, brick, and stone with our advanced soft wash systems and provide thorough window cleaning for residential and commercial properties.
                  </p>
                  <p>
                    Our professional power washing and roof cleaning services are designed to maintain and enhance Oakton's diverse residential and commercial properties, from traditional family homes to modern businesses along Route 123 and Chain Bridge Road.
                  </p>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-8 border border-blue-200">
                  ...
                  <p className="text-slate-700 text-lg leading-relaxed mb-4">
                    Oakton homeowners and businesses trust our reliable power washing and exterior house cleaning services. We provide prompt, professional service with flexible scheduling to fit your needs.
                  </p>
                  <p className="text-slate-700 text-lg leading-relaxed">
                    Quick response times, meticulous attention to detail, and courteous service—professional quality for every property.
                  </p>
                </div>
                ...
                <div className="bg-gradient-to-br from-cyan-50 to-blue-50 rounded-2xl p-8 border border-cyan-200">
                  ...
                  <p className="text-slate-700 text-lg leading-relaxed mb-4">
                    Our reputation for exceptional roof cleaning, vinyl siding cleaning, and window cleaning has made us a preferred choice for Oakton's homeowners and business owners.
                  </p>
                  <p className="text-slate-700 text-lg leading-relaxed">
                    From residential soft wash treatments to commercial power washing, we deliver consistent quality that exceeds expectations.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-slate-800 to-blue-900 rounded-2xl p-10 text-white shadow-xl">
                <h3 className="text-2xl md:text-3xl font-bold mb-6">
                  Why Oakton Properties Choose Skywash
                </h3>
                <div className="grid md:grid-cols-2 gap-x-8 gap-y-3">
                  <div className="flex items-start gap-3">
                    <CheckCircle2 size={20} className="flex-shrink-0 mt-1" />
                    <span className="text-lg">Professional power washing services</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle2 size={20} className="flex-shrink-0 mt-1" />
                    <span className="text-lg">Expert roof cleaning</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle2 size={20} className="flex-shrink-0 mt-1" />
                  ...
                  <div className="flex items-start gap-3">
                    <CheckCircle2 size={20} className="flex-shrink-0 mt-1" />
                    <span className="text-lg">Professional window cleaning</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle2 size={20} className="flex-shrink-0 mt-1" />
                    <span className="text-lg">Complete exterior house cleaning</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6 tracking-tight">
              Oakton Professional Cleaning Services
            </h2>
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              Expert power washing, roof cleaning, and exterior house cleaning for Oakton homes and businesses
            </p>
          ...
          <div className="grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="group bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-8 border border-blue-200 hover:border-blue-400 transition-all duration-500 hover:shadow-xl">
              ...
              <h3 className="text-2xl md:text-3xl font-bold text-slate-900 mb-4">
                Residential Power Washing & Exterior House Cleaning
              </h3>
              <p className="text-slate-600 leading-relaxed mb-6 text-lg">
                Keep your Oakton home beautiful with professional exterior house cleaning. Our soft wash power washing safely removes algae from vinyl siding, brick, stone, and stucco. Complete window cleaning for sparkling results.
              </p>
              <ul className="space-y-3">
                ...
                <li className="flex items-start text-slate-700">
                  <CheckCircle2 size={20} className="text-blue-600 mr-3 mt-1 flex-shrink-0" />
                  <span>Thorough window cleaning</span>
                </li>
                <li className="flex items-start text-slate-700">
                  <CheckCircle2 size={20} className="text-blue-600 mr-3 mt-1 flex-shrink-0" />
                  <span>Protects property value</span>
                </li>
              </ul>
            </div>
            ...
            <div className="group bg-gradient-to-br from-cyan-50 to-blue-50 rounded-2xl p-8 border border-cyan-200 hover:border-cyan-400 transition-all duration-500 hover:shadow-xl">
              ...
              <h3 className="text-2xl md:text-3xl font-bold text-slate-900 mb-4">
                Professional Roof Cleaning & Restoration
              </h3>
              <p className="text-slate-600 leading-relaxed mb-6 text-lg">
                Expert roof cleaning for Oakton homes. Our soft wash methods safely remove algae stains and black streaks with gentle power washing. Safe exterior house cleaning for shingles and all roofing materials.
              </p>
              <ul className="space-y-3">
                <li className="flex items-start text-slate-700">
                ...
                <li className="flex items-start text-slate-700">
                  <CheckCircle2 size={20} className="text-cyan-600 mr-3 mt-1 flex-shrink-0" />
                  <span>Restores clean appearance</span>
                </li>
              </ul>
            </div>
            ...
            <div className="group bg-gradient-to-br from-amber-50 to-orange-50 rounded-2xl p-8 border border-amber-200 hover:border-amber-300 transition-all duration-500 hover:shadow-xl">
              ...
              <p className="text-slate-600 leading-relaxed mb-6 text-lg">
                Oakton businesses deserve professional exterior house cleaning. Expert soft wash power washing for commercial buildings and retail spaces. We remove algae from vinyl siding, provide window cleaning, and roof cleaning services.
              </p>
              <ul className="space-y-3">
                <li className="flex items-start text-slate-700">
                ...
                <li className="flex items-start text-slate-700">
                  <CheckCircle2 size={20} className="text-amber-600 mr-3 mt-1 flex-shrink-0" />
                  <span>Enhances business image</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-4">
              Serving Oakton & Vale Communities
            </h2>
            <p className="text-xl text-slate-600">
              Professional power washing and roof cleaning specialists
            </p>
          </div>

          <div className="max-w-4xl mx-auto">
            <DynamicSectionImage
              section="locations/oakton-local"
              title="Oakton Local Service Area"
              altText="Professional power washing and exterior cleaning services in Oakton, VA"
          ...
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 tracking-tight">
                Aviation-Grade Precision for Every Property
              </h2>
              <p className="text-xl text-cyan-200">
                FAA-certified private pilot operated with professional standards
              </p>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="bg-white/5 backdrop-blur-md rounded-2xl p-6 border border-white/10 hover:bg-white/10 transition-all duration-300 text-center">
                ...
                <p className="text-cyan-100 text-base leading-relaxed">
                  Dedicated to serving Oakton's homes and businesses with the highest quality vinyl siding cleaning and window cleaning services.
                </p>
              </div>
            </div>
            ...
            <div className="mt-12 bg-gradient-to-r from-blue-600/20 to-cyan-600/20 backdrop-blur-md rounded-2xl p-8 md:p-10 border border-cyan-400/30">
              <div className="text-center">
                ...
                <p className="text-cyan-100 text-lg leading-relaxed max-w-3xl mx-auto">
                  We combine state-of-the-art soft wash technology with professional expertise to deliver exceptional power washing, roof cleaning, and exterior house cleaning results. Our methods safely remove algae from vinyl siding, eliminate roof stains, and provide thorough window cleaning for Oakton's residential and commercial properties.
                </p>
              </div>
            </div>
          </div>
      ...
      <section id="contact-form" className="py-20 bg-gradient-to-b from-blue-50 to-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6 tracking-tight">
              Request Your Professional Service Quote
            </h2>
            <p className="text-xl text-slate-600 max-w-2xl mx-auto">
              Expert power washing and roof cleaning services for Oakton properties
            </p>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-600 to-cyan-600 mx-auto mt-6"></div>
          </div>
          ...
          <form className="bg-white rounded-2xl shadow-xl p-8 md:p-10 border border-blue-200">
            ...
            <div className="mb-6">
              ...
              >
                ...
                <option value="oakton-village">Oakton Village</option>
                <option value="vale">Vale</option>
                <option value="waples-mill">Waples Mill</option>
                <option value="blake-lane">Blake Lane</option>
                <option value="hunter-mill">Hunter Mill</option>
            ...
            <div className="mb-6">
              ...
              >
                ...
                <option value="power-washing">Residential Power Washing & Exterior House Cleaning</option>
                <option value="roof-cleaning">Professional Roof Cleaning & Restoration</option>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            <div>
              ...
              <p className="text-blue-300 text-xl font-semibold mb-1">Serving Oakton, VA & Surrounding Areas</p>
